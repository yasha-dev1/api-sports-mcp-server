...
class CacheService:
    ...
    async def get_teams(self, params: Dict[str, Any]) -> Optional[Any]:
    ...
    async def get_fixtures(self, params: Dict[str, Any], is_completed: bool = False) -> Optional[Any]:
    ...
    async def get_statistics(self, params: Dict[str, Any]) -> Optional[Any]:
    ...
    async def get_standings(self, params: Dict[str, Any]) -> Optional[Any]:
    ...
    async def get_predictions(self, params: Dict[str, Any]) -> Optional[Any]:
